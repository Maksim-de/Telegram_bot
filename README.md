...
*   **Logging:** Модуль для логирования действий пользователя.
*   **aiogram FSM:** Для работы с состояниями пользователя.
...
2.  Установите зависимости:
    ...
    ```
3.  Создайте файл `.env` и добавьте в него `BOT_TOKEN=your_bot_token`.
4.  Запустите бота:
    ```bash
    python main.py
    ```
5.  Откройте Telegram и найдите своего бота.
6.  Начните использовать бота, введя команду `/start`.
